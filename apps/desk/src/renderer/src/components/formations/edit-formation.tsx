...
import { FormationFormData, ParticipantFormData } from '@renderer/utils/schemas/formSchema';
...
const EditFormation = ({ crud, defaultValues, goBack }: EditFormationProps): JSX.Element => {
