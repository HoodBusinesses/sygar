      ...
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6 ">
          ...
          <div className="flex flex-col w-3/4">
            ...
            />
            {errors.ice && <span className="text-sm text-red-500">{errors.ice.message}</span>}
          </div>
          ...
          <div className="flex flex-col w-3/4 ">
            ...
            />
            {errors.cnss && <span className="text-sm text-red-500">{errors.cnss.message}</span>}
          </div>

          <div className="flex flex-col w-3/4">
            <p className="text-sm text-gray-950">
              {t('registration.basicInfo.fields.address.label')}{' '}
          ...
          <div className="flex flex-col w-3/4">
            <p className="text-sm text-gray-950">
              {t('registration.basicInfo.fields.email.label')}{' '}
              <span className="text-red-500">*</span>
            </p>
            <Input
              {...register('email')}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col items-center justify-center border border-dashed rounded-md p-4 cursor-pointer hover:bg-gray-50 w-3/4">
              <input type="file" {...register('logo')} className="hidden" id="logo" />
          ...
          <div className="flex flex-col w-3/4">
            <p className="text-sm text-gray-950">
              {t('registration.basicInfo.fields.responsibleName.label')}{' '}
              <span className="text-red-500">*</span>
            </p>
            <Input
            ...
            {errors.responsibleName && (
              <span className="text-sm text-red-500">{errors.responsibleName.message}</span>
            )}
          </div>

          <div className="flex flex-col w-3/4">
            <p className="text-sm text-gray-950">
              {t('registration.basicInfo.fields.trainingManagerName.label')}{' '}
              <span className="text-red-500">*</span>
            </p>
            <Input
            ...
            {errors.trainingManagerName && (
              <span className="text-sm text-red-500">{errors.trainingManagerName.message}</span>
            )}
          </div>
        </div>
      </CardContent>
