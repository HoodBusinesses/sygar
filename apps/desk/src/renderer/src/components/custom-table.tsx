...
export function CustomTable<TData, TValue>({ columns, data, headTitle }: DataTableProps<TData, TValue>) {
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-6 gap-4">
        <ListingHeader headTitle={headTitle} onSearchChange={(e) => table.setGlobalFilter(e.target.value)} />
      </div>
