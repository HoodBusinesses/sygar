    ...
    <div className="space-y-5">
      <div className="grid grid-cols-5 gap-4">
        ...
        <div className="flex flex-col">
          ...
          >
            <SelectTrigger className="text-gray-700">
              <SelectValue placeholder={t('placeholders.selectRole')} /> {/* Translated placeholder */}
            </SelectTrigger>
        ...
        <div className="flex flex-col">
          ...
          >
            <SelectTrigger className="text-gray-700">
              <SelectValue placeholder={t('placeholders.selectActionType')} /> {/* Translated placeholder */}
            </SelectTrigger>
            <SelectContent className="text-gray-700 bg-white">
