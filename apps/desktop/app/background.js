...
(async () => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_1__.app.setAsDefaultProtocolClient('sygar');

  // handle sygar protocol req
  electron__WEBPACK_IMPORTED_MODULE_1__.app.on('open-url', function (event, data) {
  ...
  console.log('****** preload.js path:', path__WEBPACK_IMPORTED_MODULE_0___default().join(__dirname, 'preload.js'));
  if (isProd) {
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on('auth-success', (event, arg) => {
  ...
  const mainWindow = electron__WEBPACK_IMPORTED_MODULE_1__.BrowserWindow.getFocusedWindow();
  if (mainWindow) {
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.on('show-notification', (event, {
  title,
  body
}) => {
  const notification = new electron__WEBPACK_IMPORTED_MODULE_1__.Notification({
    title,
    body
  });
  notification.show();
});
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('save-file', async (event, content) => {
  // Get the default save directory
  console.log('saveFile called with content:', content);
  const defaultSavePath = electron__WEBPACK_IMPORTED_MODULE_1__.app.getPath('documents'); // You can use 'documents', 'downloads', etc.

  const {
    canceled,
    filePath
  } = await electron__WEBPACK_IMPORTED_MODULE_1__.dialog.showSaveDialog({
    title: 'Save File',
    defaultPath: path__WEBPACK_IMPORTED_MODULE_0___default().join(defaultSavePath, 'filename.txt'),
  ...
  if (!canceled && filePath) {
    fs__WEBPACK_IMPORTED_MODULE_4___default().writeFileSync(filePath, content);
