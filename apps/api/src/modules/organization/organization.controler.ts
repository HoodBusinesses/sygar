...
export class OrganizationController {
  ...
  async get(@Query('cnss') cnss: string, @Req() req: Request) {
    ...
    try {
      if (!cnss) throw Error('cnssRequired');
      return {
  ...
  @ApiResponse({
    status: 404,
    description: 'No organizations found for the given filters.',
  })
  async getAll(
...
export class ThemeController {
  ...
  async create(@Body() createThemeDto: CreateThemeDto, @Req() req: Request) {
    ...
    try {
      return {
        theme: await this.themeService.createTheme(createThemeDto), // Create the theme
  ...
  async get(@Query('uid') uid: string, @Req() req: Request) {
    ...
    try {
      ...
      return {
        theme: await this.themeService.getTheme(uid),
        date: new Date().toISOString(),
      };
    } catch (error: any) {
      throw new HttpException(
  ...
  async update(
    ...
    try {
      return {
        theme: await this.themeService.updateTheme(uid, updateThemeDto),
        date: new Date().toISOString(),
      };
    } catch (error: any) {
      throw new HttpException(
  ...
  @ApiResponse({
    status: 200,
    description: 'All themes retrieved successfully.',
    schema: {
      example: {
        themes: [
          {
...
export class AnimatorController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Animator created successfully.',
    schema: {
      example: {
        animator: {
          PK: '123456789',
  ...
  @ApiResponse({ status: 400, description: 'Bad request.' })
  async createAnimator(
    @Body() createAnimatorDto: CreateAnimatorDto,
    @Req() req: Request
  ) {
  ...
  @ApiResponse({
    status: 200,
    description: 'Animator retrieved successfully.',
    schema: {
      example: {
        animator: {
          PK: '123456789',
  ...
  @ApiResponse({
    status: 200,
    description: 'Animator updated successfully.',
    schema: {
      example: {
        animator: {
          PK: '123456789',
  ...
  @ApiResponse({ status: 400, description: 'Bad request.' })
  async update(
    @Body() updateAnimatorDto: UpdateAnimatorDto,
    @Query('uid') uid: string,
    @Req() req: Request
  ) {
    // Get the language from the request header
    ...
    try {
      return {
        ...
        animator: await this.animatorService.updateAnimator(
          updateAnimatorDto,
          uid
        ),
        date: new Date().toISOString(),
  ...
  @ApiResponse({
    status: 200,
    description: 'Animator deleted successfully.',
    schema: {
      example: {
...
export class FormatorController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Formator created successfully.',
    schema: {
      example: {
        formator: {
          PK: '123456789',
  ...
  @ApiResponse({ status: 400, description: 'Bad request.' })
  async createFormator(
    @Body() createFormatorDto: CreateFormatorDto,
    @Req() req: Request
  ) {
    const header: Record<string, any> = req.headers;
    const lang = header['accept-language'] ?? 'en';
  ...
  @ApiResponse({
    status: 200,
    description: 'Formator retrieved successfully.',
    schema: {
      example: {
        formator: {
          PK: '123456789',
  ...
  @ApiResponse({
    status: 200,
    description: 'Formator updated successfully.',
    schema: {
      example: {
        formator: {
          PK: '123456789',
  ...
  @ApiResponse({ status: 400, description: 'Bad request.' })
  async updateFormator(
    @Body() updateFormatorDto: UpdateFormatorDto,
    @Query('uid') uid: string,
    @Req() req: Request
  ) {
    const header: Record<string, any> = req.headers;
    ...
    try {
      return {
        ...
        formator: await this.formatorService.updateFormator(
          updateFormatorDto,
          uid
        ),
        date: new Date().toISOString(),
  ...
  @ApiResponse({
    status: 200,
    description: 'Formator deleted successfully.',
    schema: {
      example: {
...
export class ParticipantController {
  ...
  async updateParticipant(
    ...
    try {
      return {
        participant: await this.participantService.updateParticipant(
...
export class AssigningGroupController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Assigning group created successfully.',
    schema: {
      example: {
        assigningGroup: {
          PK: '123456789',
  ...
  async createAssigningGroup(
    ...
    try {
      return {
        assigningGroup:
          await this.assigningGroupService.createAssigningGroup(
            assignToGroupDto
          ),
        date: new Date().toISOString(),
      };
  ...
  @ApiResponse({
    status: 200,
    description: 'Assigning group retrieved successfully.',
    schema: {
      example: {
        assigningGroup: {
          PK: '123456789',
  ...
  @ApiResponse({
    status: 200,
    description: 'Assigning groups retrieved successfully.',
    schema: {
      example: {
        assigningGroups: [
          {
  ...
  @ApiResponse({ status: 400, description: 'Bad request.' })
  async getByEnrolleds(
    @Query('enrolledUid') enrolledUid: string,
    @Query('enrolledType') enrolledType: EnrolledType,
    @Req() req: Request
  ) {
    const header: Record<string, any> = req.headers;
    const lang = header['accept-language'] ?? 'en';
    ...
    try {
      return {
        assigningGroups: await this.assigningGroupService.getByEnrolleds(
          enrolledUid,
          enrolledType
        ),
        date: new Date().toISOString(),
  ...
  async getByGroupUid(
    ...
    try {
      return {
        assigningGroups: await this.assigningGroupService.getByGroupUid(
          groupUid,
          enrolledType
        ),
        date: new Date().toISOString(),
  ...
  @ApiResponse({
    status: 200,
    description: 'Assigning group deleted successfully.',
    schema: {
      example: {
